...
import com.kalex.bookyouu_notesapp.core.common.composables.BYRoundedCheckView
import com.kalex.bookyouu_notesapp.journal.createJournal.DayOfWeekStringFactory
import java.time.DayOfWeek

@Composable
fun JournalFormSheetContent(
    onHideClick: () -> Unit,
    ...
    Column(
        ...
        Row(
            ...
            Text(
                stringResource(id = R.string.journal_form_sheet_title),
